...
(function attachTavernService(global) {
  ...
  const CLASS_ARCHETYPES = {
    ...
    랜서: {
      ...
      namePool: ["브람", "리나르", "테오", "세린", "주리온", "재하르", "수헬", "미넥", "준벨", "하율렌"]
    },
    팔라딘: {
      weaponType: "lance",
      baseStats: { maxHp: 23, str: 8, skl: 6, spd: 7, def: 8, mov: 5 },
      namePool: ["드웨인", "마엘", "리트", "칼리아", "헨릭", "준테온", "타르건", "세르린", "시엘", "가르람"]
    },
    아처: {
      weaponType: "bow",
    ...
    헌터: {
      ...
      namePool: ["세아라", "리브", "레온", "타니아", "하민느", "수엘", "지수엘", "은호른", "시온", "도연느"]
    },
    솔저: {
      weaponType: "lance",
      baseStats: { maxHp: 18, str: 6, skl: 5, spd: 5, def: 5, mov: 4 },
      namePool: ["로건", "다엘", "베카", "소린", "민호르", "타영", "주원느", "도훈드", "세누", "서호른"]
    }
  };
